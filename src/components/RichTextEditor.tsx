...
// ─── ToolbarButton ────────────────────────────────────────────────────────────
// Declared at module scope so React doesn't create a new component type on
// every render, which would cause all toolbar buttons to unmount/remount.
...
export function RichTextEditor({
  ...
  // Sync external content changes (e.g., when parent calls handleCancel).
